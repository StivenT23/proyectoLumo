...
public class Pregunta {
    ...
    private String tipo;                    // multiple_choice, verdadero_falso, arrastrar, etc.
    private String dificultad;              // baja, media, alta
    private String respuestaCorrecta;
    private String opciones;                // JSON o lista separada por comas
    private Boolean activo;

    public Pregunta() {
    }

    public Pregunta(String id, String materiaId, String textoPregunta, String tipo,
